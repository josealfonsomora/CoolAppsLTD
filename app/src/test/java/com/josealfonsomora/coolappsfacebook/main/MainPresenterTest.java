...
public class MainPresenterTest {
    ...
    @Test
    public void user_image_is_updated_when_view_is_attached_if_is_fetched_from_facebook_without_error() {
    ...
    @Test
    public void error_toast_is_shown_when_view_is_attached_if_user_image_is_fetched_with_any_error() {
